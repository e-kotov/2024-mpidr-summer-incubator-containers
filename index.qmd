...
|                                                                                                                                                     |                                                                                                                            |
|-------------------------|---------------------------|
| **Your skills**                                                                                                                                     | **Tutorial to follow**                                                                                                     |
| You have a GitHub account, familiar with concepts of forking a repository and can edit code locally (e.g. in RStudio or VSCode) or online on GitHub | [1. Create a reproducible GitHub repository that runs in the cloud using Binder](1-reproducible-github-repo-in-binder.qmd) |
| You are familiar with basic command line (terminal) commands such as `git clone`, `cd`, `mkdir` or not afraid to try them out.                      | [2. Build your own Docker container image and run it (locally or in the cloud)](2-build-docker-container-image.qmd)       |
